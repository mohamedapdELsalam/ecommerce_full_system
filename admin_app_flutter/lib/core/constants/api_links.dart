class ApiLinks {
  ...
  static const String deleteVariant = "$role/items/delete_variant.php";
  static const String editVariant = "$role/items/update_variant.php";
  static const String updateAll = "$role/items/update_all.php";
  //coupons
