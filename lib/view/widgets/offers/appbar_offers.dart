...
import 'package:ecommerceapp/view/widgets/offers/bottom_appbar_offers.dart';
import 'package:ecommerceapp/view/widgets/offers/top_appbar_offers.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Flexible(child: TopAppbarOffers()),
                Flexible(child: BottomAppbarOffers())
              ],
            ),
          ),
        ],
