import 'package:adminapp/controller/auth/forgetPassword_controller.dart';
...
import 'package:adminapp/view/widgets/Auth/forgetpass_bottom_text.dart';
        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              ForgetPassBottomText(firsText: "return to ", SecondText: "login"),
            ],
          ),
        ),
      ),
