...
ThemeData lightTheme() {
  ...
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderSide: BorderSide(
            color: AppLightColors.primaryColor), // تعيين لون الحدود للحقول
        borderRadius: BorderRadius.circular(8), // تعيين الزوايا المدورة
      ),
      hintStyle: TextStyle(
          color: AppLightColors.onSurface), // تعيين لون النصوص في الـ hint
      labelStyle: TextStyle(
          color: AppLightColors.onSurface), // تعيين لون النصوص في الـ label
    ),
    ...
    dividerTheme: DividerThemeData(
      color:
          AppLightColors.onSurface.withOpacity(0.5), // تعيين لون الخطوط الفاصلة
      thickness: 1,
      space: 16,
    ),
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      backgroundColor: AppLightColors
